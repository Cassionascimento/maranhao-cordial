...
CREATE TABLE crm_identidades_canal(id TEXT PRIMARY KEY,lead_id TEXT REFERENCES leads_crm(id),canal TEXT NOT NULL,identificador_externo TEXT NOT NULL,tipo TEXT NOT NULL,verificado BOOLEAN DEFAULT FALSE,primeira_vez_em TEXT DEFAULT CURRENT_TIMESTAMP,ultima_vez_em TEXT DEFAULT CURRENT_TIMESTAMP);
CREATE UNIQUE INDEX crm_identidades_canal_unica ON crm_identidades_canal(canal,identificador_externo);
